        ...
        <div class="col-md-6">
            ...
            <form action="handle-company" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Company name here"/>
                </div>
                <div class="form-group">
                    <label for="country">Country</label>
                    <input class="form-control" name="country" id="country" placeholder="Enter country here" />
                </div>
                <div class="form-group">
